...
class BnopObjects(
    ...
    def add_to_registry_keyed_on_ckid_type(
        ...
        if boro_object_ck_id in self.registry_keyed_on_ckid_type:
            ckid_typed_objects = \
                self.registry_keyed_on_ckid_type[boro_object_ck_id]
        else:
            ckid_typed_objects = \
                set()
        ...
        ckid_typed_objects.add(
            self)

    @staticmethod
    def import_bnop_object(
            bnop_object):
